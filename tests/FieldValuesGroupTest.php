...
class FieldValuesGroupTest extends TestCase
{
    ...
    public function can_add_a_new_group_on_fieldable() {
        ...
        $this->fieldable->addField( [
            'field_type_id'=>null,
        ] );

        $this->assertEquals( 1, $this->fieldable->fields()->count() );
        $this->assertTrue( $this->fieldable->fields()->first()->isGroup() );
    }
